...
pub struct AppState {
    ...
    pub update_info: Option<pulsebar::updater::UpdateInfo>,
    ...
    /// Proof-harness configuration (set when `PULSEBAR_PROOF_MODE` is active).
    pub proof_config: Option<ProofConfig>,
    /// Persistent notification manager — tracks which alerts have fired to prevent spam.
    pub notification_manager: pulsebar::notifications::NotificationManager,
...
impl AppState {
    ...
    pub fn new() -> Self {
        Self {
            ...
            installer_path: None,
            proof_config: None,
            notification_manager: pulsebar::notifications::NotificationManager::new(),
            last_shown_at: None,
