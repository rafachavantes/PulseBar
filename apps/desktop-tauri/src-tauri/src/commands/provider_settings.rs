...
pub fn reorder_providers(
    ...
    settings.provider_order = pulsebar::settings::normalize_provider_order(&ids);
...
fn cookie_source_provider(provider_id: &str) -> Option<pulsebar::core::ProviderId> {
...
fn region_provider(provider_id: &str) -> Option<pulsebar::core::ProviderId> {
    use pulsebar::core::ProviderId;
    Some(match provider_id {
        "zai" => ProviderId::Zai,
        _ => return None,
