  ...
  return (
    <>
      ...
      <section className="settings-section">
        ...
        <div className="settings-section__group">
          <Field
            label={t("MenuContentModeLabel")}
            description={t("MenuContentModeHelper")}
          >
            <Select
              value={settings.menuContentMode}
              disabled={saving}
              options={[
                { value: "lean", label: t("MenuContentModeLean") },
                { value: "full", label: t("MenuContentModeFull") },
              ]}
              onChange={(v) => set({ menuContentMode: v as MenuContentMode })}
            />
          </Field>
          <Field
