...
mod tests {
    ...
    fn test_migration_item_label() {
        let item = MigrationItem::new("PulseBar").with_account("claude-cookie");
        assert_eq!(item.label(), "PulseBar:claude-cookie");

        let item = MigrationItem::new("PulseBar");
        assert_eq!(item.label(), "PulseBar:<any>");
    }
    ...
    fn test_service_name_for_provider() {
        assert_eq!(service_name_for_provider(ProviderId::Claude), "PulseBar");
        assert_eq!(service_name_for_provider(ProviderId::Codex), "PulseBar");
    }
    ...
    fn test_account_name_for_provider() {
        ...
        assert_eq!(account_name_for_provider(ProviderId::Zai), "zai-api-token");
    }
