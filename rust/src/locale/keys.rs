...
impl LocaleKey {
    ...
    pub const ALL: &'static [(LocaleKey, &'static str)] = &[
        ...
        (LocaleKey::TrayOpenPulseBar, "TrayOpenPulseBar"),
        ...
        (LocaleKey::ResetsInMinutes, "ResetsInMinutes"),
        ...
        (LocaleKey::MenuContentModeLabel, "MenuContentModeLabel"),
        (LocaleKey::MenuContentModeHelper, "MenuContentModeHelper"),
        (LocaleKey::MenuContentModeLean, "MenuContentModeLean"),
        (LocaleKey::MenuContentModeFull, "MenuContentModeFull"),
        ...
        (
            LocaleKey::DetailPaceRunsOutInMinutes,
        ...
        (
            LocaleKey::TrayTooltipMoreProviders,
            "TrayTooltipMoreProviders",
        ),
        // Onboarding UX — first-run empty state + summon shortcut hint
        (LocaleKey::EmptyStateHeadline, "EmptyStateHeadline"),
        (
            LocaleKey::EmptyStateProvidersCaption,
            "EmptyStateProvidersCaption",
        ),
        (LocaleKey::TrayShortcutHintLabel, "TrayShortcutHintLabel"),
        // Onboarding UX — credential save feedback
        (LocaleKey::CredentialSaving, "CredentialSaving"),
        (LocaleKey::CredentialSaved, "CredentialSaved"),
        // Onboarding UX — provider sign-in visibility
        (LocaleKey::ActionSignIn, "ActionSignIn"),
        (LocaleKey::SignInToProvider, "SignInToProvider"),
    ];
}
