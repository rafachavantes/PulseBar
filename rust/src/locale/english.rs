...
impl LocaleKey {
    pub(super) fn english(self) -> &'static str {
        match self {
            ...
            // About
            LocaleKey::AboutTitle => "About PulseBar",
            ...
            LocaleKey::MenuAbout => "About PulseBar",
            ...
            LocaleKey::TrayOpenPulseBar => "Pop Out Dashboard",
            ...
            LocaleKey::TrayLoading => "PulseBar - Loading...",
            LocaleKey::TrayNoProviders => "PulseBar - No providers available",
            ...
            LocaleKey::ResetsInMinutes => "Resets in {}m",
            ...
            LocaleKey::ProviderClaudeAvoidKeychainPromptsHelp => {
                "Use /usr/bin/security to read Claude credentials and avoid PulseBar keychain prompts."
            }
            ...
            LocaleKey::InstallUpdatesOnQuitHelper => {
                "Automatically launch a ready installer when you quit PulseBar"
            }

            // Keyboard shortcuts
            LocaleKey::KeyboardShortcutsTitle => "Keyboard Shortcuts",
            LocaleKey::GlobalShortcutLabel => "Global Shortcut",
            LocaleKey::GlobalShortcutHelper => "Press this shortcut to open PulseBar from anywhere",
            ...
            LocaleKey::MenuContentModeLabel => "Card detail level",
            LocaleKey::MenuContentModeHelper => {
                "Lean shows only session, weekly, pace and tokens; Full shows every section."
            }
            LocaleKey::MenuContentModeLean => "Lean (essentials)",
            LocaleKey::MenuContentModeFull => "Full (all details)",
            ...
            LocaleKey::DetailPaceRunsOutInMinutes => "Runs out in ~{}m",
            ...
            LocaleKey::CredsJetBrainsHelperMissing => {
                "Install a JetBrains IDE with AI Assistant enabled, then refresh PulseBar."
            }
            ...
            LocaleKey::TrayTooltipMoreProviders => "+{} more",

            // Onboarding UX — first-run empty state + summon shortcut hint
            LocaleKey::EmptyStateHeadline => "All your AI usage, one glance.",
            LocaleKey::EmptyStateProvidersCaption => {
                "Tracks Codex, Claude, Gemini, z.ai, Grok, OpenCode Go"
            }
            LocaleKey::TrayShortcutHintLabel => "Summon",

            // Onboarding UX — credential save feedback
            LocaleKey::CredentialSaving => "Saving…",
            LocaleKey::CredentialSaved => "Saved ✓",

            // Onboarding UX — provider sign-in visibility
            LocaleKey::ActionSignIn => "Sign in",
            LocaleKey::SignInToProvider => "Sign in to {}",
        }
    }
}
