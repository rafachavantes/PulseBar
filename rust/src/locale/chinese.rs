...
impl LocaleKey {
    pub(super) fn chinese(self) -> &'static str {
        match self {
            ...
            LocaleKey::StartAtLoginHelper => "登录后自动启动 PulseBar",
            ...
            // About
            LocaleKey::AboutTitle => "关于 PulseBar",
            ...
            LocaleKey::MenuAbout => "关于 PulseBar",
            ...
            LocaleKey::TrayOpenPulseBar => "弹出仪表盘",
            ...
            LocaleKey::TrayLoading => "PulseBar - 加载中...",
            LocaleKey::TrayNoProviders => "PulseBar - 无可用服务商",
            ...
            LocaleKey::ResetsInMinutes => "{} 分钟后重置",
            ...
            LocaleKey::ProviderClaudeAvoidKeychainPromptsHelp => {
                "使用 /usr/bin/security 读取 Claude 凭据，避免 PulseBar 的钥匙串提示。"
            }
            ...
            LocaleKey::InstallUpdatesOnQuitHelper => "退出 PulseBar 时自动启动已准备好的安装器",

            // Keyboard shortcuts
            LocaleKey::KeyboardShortcutsTitle => "快捷键",
            LocaleKey::GlobalShortcutLabel => "全局快捷键",
            LocaleKey::GlobalShortcutHelper => "按此快捷键可从任何位置打开 PulseBar",
            ...
            // About tab
            LocaleKey::AboutDescription => "PulseBar 的 Windows 移植版本。",
            ...
            LocaleKey::MenuContentModeLabel => "卡片信息量",
            LocaleKey::MenuContentModeHelper => {
                "精简模式仅显示会话、每周、节奏与令牌;完整模式显示全部信息。"
            }
            LocaleKey::MenuContentModeLean => "精简(仅核心)",
            LocaleKey::MenuContentModeFull => "完整(全部信息)",
            ...
            LocaleKey::DetailPaceRunsOutIn => "预计约 {} 小时后用完",
            LocaleKey::DetailPaceRunsOutInMinutes => "预计约 {} 分钟后用完",
            ...
            LocaleKey::CredsJetBrainsHelperMissing => {
                "请安装启用了 AI Assistant 的 JetBrains IDE，然后刷新 PulseBar。"
            }
            ...
            LocaleKey::TrayTooltipMoreProviders => "另外 {} 项",

            // Onboarding UX — first-run empty state + summon shortcut hint
            LocaleKey::EmptyStateHeadline => "所有 AI 用量，一目了然。",
            LocaleKey::EmptyStateProvidersCaption => {
                "追踪 Codex、Claude、Gemini、z.ai、Grok、OpenCode Go"
            }
            LocaleKey::TrayShortcutHintLabel => "唤出",

            // Onboarding UX — credential save feedback
            LocaleKey::CredentialSaving => "保存中…",
            LocaleKey::CredentialSaved => "已保存 ✓",

            // Onboarding UX — provider sign-in visibility
            LocaleKey::ActionSignIn => "登录",
            LocaleKey::SignInToProvider => "登录 {}",
        }
    }
}
