...
//!
//! Matches the original PulseBar CLI structure:
//! - `pulsebar` - launches the menu bar GUI app (default)
//! - `pulsebar usage` - print usage from providers
//! - `pulsebar cost` - print local token cost usage
//! - `pulsebar autostart` - manage Windows auto-start
...
/// Exit codes matching original PulseBar
pub mod exit_codes {
...
/// PulseBar - Monitor AI provider usage limits
///
