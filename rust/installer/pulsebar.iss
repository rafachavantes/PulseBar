#define MyAppName "PulseBar"
  ...
  #define OutputBaseFilename "PulseBar-" + AppVersion + "-Setup"
#endif
#ifndef VCRedistPath
...
AppPublisher=Rafael Chavantes
AppPublisherURL=https://github.com/rafachavantes/PulseBar
AppSupportURL=https://github.com/rafachavantes/PulseBar/issues
AppUpdatesURL=https://github.com/rafachavantes/PulseBar/releases
DefaultDirName={localappdata}\Programs\PulseBar
DefaultGroupName=PulseBar
...
UninstallDisplayIcon={app}\pulsebar-desktop.exe
...
[Files]
Source: "{#TargetBinDir}\pulsebar.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#TargetBinDir}\pulsebar-desktop.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{autoprograms}\PulseBar"; Filename: "{app}\pulsebar-desktop.exe"; Parameters: "menubar"; WorkingDir: "{app}"; IconFilename: "{app}\icon.ico"
Name: "{autodesktop}\PulseBar"; Filename: "{app}\pulsebar-desktop.exe"; Parameters: "menubar"; WorkingDir: "{app}"; Tasks: desktopicon; IconFilename: "{app}\icon.ico"

[Run]
Filename: "{app}\pulsebar-desktop.exe"; Parameters: "menubar"; Description: "Launch PulseBar"; Flags: nowait postinstall skipifsilent; Check: CanLaunchPulseBar
...
function CanLaunchPulseBar(): Boolean;
begin
