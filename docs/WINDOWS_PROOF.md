...
cargo test -p pulsebar-desktop-tauri
cargo clippy -p pulsebar-desktop-tauri --all-targets -- -D warnings
...
powershell -ExecutionPolicy Bypass `
  ...
  -InstallerPath .\rust\target\installer\PulseBar-<version>-Setup.exe `
...
After installing the built `.msi`, launch **PulseBar** and walk through
...
[ ] build.tauri-clippy            cargo clippy -p pulsebar-desktop-tauri --all-targets -- -D warnings
[ ] build.tauri-test              cargo test -p pulsebar-desktop-tauri
